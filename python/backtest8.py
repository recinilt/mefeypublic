...
take_profit_percs = np.arange(0.0030, 0.0200, 0.0010)
...
with tqdm(total=len(param_combinations), desc="Testing parameter combinations") as pbar:
    for vwap_offset, take_profit_perc, stop_loss_perc in param_combinations:
