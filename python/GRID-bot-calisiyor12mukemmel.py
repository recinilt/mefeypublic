...
def process_close_values(data):
    ...
    try:
        ...
        if len(data) > 0:
            ...
            file_name = f"{symbol}-{veri_days_back}gun-gridKarYuzde{round((gridprofit / yavilkbakiyeiste), 2) * 100}-bakiyeYuzde{round(kazancorani, 2)}-aralikYuzde{geometric_percentage}-{get_current_datetime_text()}"
