...
def cift_ema_sinyal(liste, kisa_span=10, uzun_span=20):
    """
...
def AnaFonkKA(raw_text):
    ...
    if result[0][0]>-1 and ortalamayagorepozisyonacayimmi("long"): # and not io15m1h4hdusuktemi():
        ...
        for coin in result:
            ...
            if binle(coin[0]) in mysymbols3 and coin[2]<2 and coin[2]>1.1 and coin[3]>1.01 and coin[5]==True and coin[6]<10 and acabilirmiyim(binle(coin[0])):
