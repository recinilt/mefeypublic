...
def collect_data(symbols, intervals, start_date, end_date):
...
if __name__ == "__main__":
    symbols = ["BTCUSDT", "ONEUSDT"]  # List of symbols
    intervals = ["1m","5m"]  # List of intervals
    start_date = "2024-01-17"  # Start date in YYYY-MM-DD
    end_date = "2024-12-27"  # End date in YYYY-MM-DD
    collect_data(symbols, intervals, start_date, end_date)
