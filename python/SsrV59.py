...
def AnaFonkSSR3(raw_text):
    ...
    for mylist in parsed_data:
        ...
        if almakkosulu() and mylist[2][1] and mylist[2][2] and mylist[2][3]   and mylist[3]>12 and mylist[5]<3 and mylist[0] in mysymbols3: # and ((iopower[-1]<1 and cift_ema_sinyal(iopower)[0]) or (iopower[-1]>0.9) ) and fiyat_dalgalanma_takip_ssr2(ssrtrailing,mylist[0])
            print(mylist[0])
