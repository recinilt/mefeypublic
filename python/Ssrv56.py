...
def almakkosulu():
    myresult = (io1d[-1]>50 and apalayimmi and iopower[-1]>=1) or (io1d[-1]>48.9 and apalayimmi and iopower[-1]>=1)# and (cift_ema_sinyal(io1d)[0]) and (not son_bes_esit_mi(io1d))) 
    return myresult
...
def AnaFonkSSR3(raw_text):
    ...
    for mylist in parsed_data:
        if almakkosulu() and mylist[2][0] and mylist[2][1] and mylist[2][2] and mylist[2][3] and mylist[3]>8 and mylist[0] in mysymbols3: 
            print(mylist[0])
