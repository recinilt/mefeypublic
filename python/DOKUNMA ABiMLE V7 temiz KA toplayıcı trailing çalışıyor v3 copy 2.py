...
def trailinghesapla():
    if io1d[-1]>50:
        ...
        return round((trailingyuzde / 3),2)
...
def AnaFonkGrio(raw_text):
    ...
    if almakkosulu():
        ...
        print("almak koşulu sağlanamadı. io :coin")
...
async def main():
    ...
    async def handler(event):
        ...
        if event.raw_text.startswith("???????Belirtilen Coin Grubu İçin Nakit Girişi Raporu.") and "%100" in event.raw_text: #IO Coin
        ...
        if event.raw_text.startswith("Belirtilen Coin Grubu İçin Nakit Girişi Raporu") and not "%100" in event.raw_text: #io :group
            #AnaFonkGrio(event.raw_text)   
            while True:
                if calissinmi:
                    AnaFonkGrio(event.raw_text)
    ...
    while True:
        if True:
            ...
            iofio=["iof","io"]
            kaio=["ka","io"]
            griolu=["iof","iof","ka","ka","ka","ka","ka","ka","ka","ap","ap","grio","io","io","io","io","io","io","io","io","io","io","io","io","io","io","io","io","io","ka","ka","ka","ka","ka","ka","ka","ka","ka","ka","io :l1","io :meme","io :çin","io :game","io :web3","io :eth","io :lpol","io :defi","io :dex","io :trx","io :depin","io :ai","io :sol","io :l2","io :dcomp","io :file","io :ton","io :rwa","io :rst","io :fan"]
            ...
            while True:
                if calissinmi:
                    await telegram_client.send_message(target_user, "ka")
                    await asyncio.sleep(rastgele_sayi(30,45))  # 100 ile 400 saniye arasında rastgele bir saniyede bir mesaj gönder
                    break
                else:
                    await asyncio.sleep(2)
