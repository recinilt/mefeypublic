...
client.futures_change_leverage(symbol="BTCUSDT", leverage=125)  # Set leverage to 100x
try:
...
vwap_offset = 0.0016  # 0.15%
take_profit_perc = 0.0138 # 1.2%
stop_loss_perc = 0.006  # 0.13%
quantity = 0.008  # Adjust based on balance and risk
