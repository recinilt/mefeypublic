...
def rastgele_komut():
    ...
    kacincilar.clear()
    kacincilar.append(int(rastgele_sayi(0,1)))
    kacincilar.append(1 if kacincilar[0]==0 else 0)
...
async def main():
    ...
    while True:
        ...
        await client.send_message(target_user, mysent[kacincilar[0]]) #mysent[rastgele_komut()] )#'marketanaliz')
        await asyncio.sleep(rastgele_sayi(50,100))
        await client.send_message(target_user, mysent[kacincilar[1]]) #mysent[1] if kacinci == 0 else mysent[0])#'sdv')
