...
def BTCdurumu():
    ...
    try:
        ...
        if close_prices[-1]>0.99*open_prices[-1] and open_prices[-1]>open_prices[-2] and open_prices[-2]>open_prices[-3] :#and open_prices[-3]>open_prices[-4]:
            yukselisdusus.append(True)
        else:
            yukselisdusus.append(False)
        
        if close_prices[-1]<open_prices[-1]*1.01 and open_prices[-1]<open_prices[-2] and open_prices[-2]<open_prices[-3] :#and open_prices[-3]<open_prices[-4]:
            yukselisdusus.append(True)
        else:
            yukselisdusus.append(False)
