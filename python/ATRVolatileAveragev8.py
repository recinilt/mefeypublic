...
mytimeframe=input("Zaman dilimi (Örn. 5m) (Örn. 1m, 5m, 15m, 1h, 4h, 12h, 1d): ")
mylimit=int(input("Geriye dönük kaç zaman dilimi çekilsin? (Örn. 3000): "))
...
top_100_symbols.sort()
def fetch_data(symbol, timeframe=mytimeframe, limit=mylimit):
...
# Sonuçları yazdırma
print("symbol, atr, average atr",results)
